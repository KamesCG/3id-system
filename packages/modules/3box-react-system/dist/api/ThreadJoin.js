...
var OpenSpace = (_ref) => {
  ...
  }))), login.isDispatched && !login.isLoggedIn && (0, _uiCompose.Component)(props.componentIsLoading, _objectSpread({}, styleDefault)), login.isLoggedIn && !space.isDispatched && _react.default.createElement("span", {
    onClick: setRequest
  }, (0, _uiCompose.Component)(props.componentIsLoggedIn, _objectSpread({}, styleDefault))), login.isLoggedIn && space.isDispatched && !space.isOpen && (0, _uiCompose.Component)(props.componentSpaceRequest, _objectSpread({}, styleDefault)), space.isOpen && !thread.isDispatched && _react.default.createElement("span", {
    onClick: setThreadRequest
  }, (0, _uiCompose.Component)(props.componentIsLoggedIn, _objectSpread({}, styleDefault))), space.isOpen && thread.isDispatched && !thread.isReady && (0, _uiCompose.Component)(props.componentThreadRequested, _objectSpread({}, styleDefault)), space.isOpen && thread.isDispatched && thread.isReady && (0, _uiCompose.Component)(props.componentThreadJoined, _objectSpread({}, styleDefault)));
};

var LoggedOut = props => _react.default.createElement(_designSystemAtoms.Span, props, props.loggedOutLabel);

var Loading = props => _react.default.createElement(_designSystemAtoms.Span, props, "Logging In");
