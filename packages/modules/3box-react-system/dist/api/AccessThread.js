...
var AccessThread = (_ref) => {
  ...
  }), login.isLoggedIn && !isSpaceReady ? _react.default.createElement(_SpaceOpen.default, {
    space: props.space,
    auto: props.spaceAuto,
    componentIsClosed: props.componentIsClosed,
    componentIsLoading: props.componentIsLoading,
    componentIsOpen: props.componentIsOpen
  }) : null, login.isLoggedIn && isSpaceReady && !thread.isReady ? _react.default.createElement(_ThreadJoin.default, {
  ...
  }) : null, login.isLoggedIn && isSpaceReady && thread.isReady ? props.children : null);
};
