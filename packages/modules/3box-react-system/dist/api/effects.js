...
exports.default = exports.useThreadListenEffect = exports.useThreadPostDeleteRequestEffect = exports.useThreadReadyEffect = exports.useThreadJoinEffect = exports.useStorageDeleteRequestEffect = exports.useStorageInsertRequestEffect = exports.useStorageRemoveRequestEffect = exports.useStorageSelectorEffect = exports.useSpaceOpenRequestEffect = exports.useSpaceReadyEffect = exports.useLoggedInEffect = exports.useOpenRequestEffect = exports.useEnableEffect = void 0;
...
var useOpenRequestEffect = (state, props) => {
  ...
  var [isDispatched, setDispatched] = (0, _react.useState)(false);
  (0, _react.useEffect)(() => {
    if (state.isLoggingIn) setDispatched(true);
  }, [state.isLoggingIn]);
  (0, _react.useEffect)(() => {
    if (state.isLoggedIn) setEnabled(true);
  }, [state.isLoggedIn]);
  return {
