...
var AccessSpaces = (_ref) => {
  ...
  return _react.default.createElement(_react.default.Fragment, null, login.isLoggedIn ? null : _react.default.createElement(_Login.default, props), login.isLoggedIn && !isSpaceReady ? _react.default.createElement(_SpaceOpen.default, {
    space: props.space,
    auto: props.spaceAuto
  }) : null, login.isLoggedIn && isSpaceReady ? props.children : null);
};
