...
var OpenSpace = (_ref) => {
  ...
  return _react.default.createElement(_react.default.Fragment, null, !login.isDispatched && !login.isLoggedIn && _react.default.createElement(_react.default.Fragment, null, (0, _uiCompose.Component)(props.componentIsLoggedOut, _objectSpread({}, styleDefault, {
    ...
    onClick: setRequest
  }, (0, _uiCompose.Component)(props.componentIsLoggedIn, _objectSpread({}, styleDefault))), login.isLoggedIn && space.isDispatched && !space.isOpen && (0, _uiCompose.Component)(props.componentSpaceRequest, _objectSpread({}, styleDefault)), login.isLoggedIn && space.isDispatched && space.isOpen && (0, _uiCompose.Component)(props.componentSpaceOpen, _objectSpread({}, styleDefault, {
    space: props.space
  })));
};
