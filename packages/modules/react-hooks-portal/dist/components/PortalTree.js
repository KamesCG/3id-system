...
var Component = (_ref) => {
  ...
  return _react.default.createElement(_Context.default.Consumer, null, portal => _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_PortalCreate.default, {
    ...
    portal: portal
  }, modal)))), portal.store.toasts && Array.isArray(portal.store.toasts) && portal.store.toasts.length > 0 && _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_designSystemAtoms.Box, {
