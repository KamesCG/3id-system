...
var Modal = (0, _styledComponents.default)(_designSystemAtoms.Flex)(_templateObject(), (0, _styledSystem.variant)({
  variants: {
    default: {
      left: 0,
      right: 0,
...
var ModalInner = (0, _styledComponents.default)(_designSystemAtoms.Flex)(_templateObject2(), (0, _styledSystem.variant)({
  variants: {
    default: {
      center: true,
      column: true,
...
var ModalActions = (_ref) => {
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_reactTransitionGroup.CSSTransition, {
    ...
    column: true,
    variant: variant
  }, styled), _react.default.createElement(_designSystemAtoms.BackgroundGradient, {
    bg: "black",
    fixed: true,
    absolute: false,
    opacity: .2,
    onClick: closeHandler
  }), _react.default.createElement(ModalInner, _extends({
