...
var Panel = (0, _styledComponents.default)(_designSystemAtoms.Box)(_templateObject(), (0, _styledSystem.variant)({
  prop: 'position',
  variants: {
    default: {
      right: 0,
...
var PanelActions = (_ref) => {
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_reactTransitionGroup.CSSTransition, {
    ...
    timeout: 300,
    classNames: "fadeInLeft"
  }, !isOpening ? _react.default.createElement("div", null) : _react.default.createElement(Panel, _extends({}, styled, styled), label && _react.default.createElement(_designSystemAtoms.Flex, _extends({
    alignCenter: true,
    between: true,
    fullWidth: true,
    gradient: "gray",
