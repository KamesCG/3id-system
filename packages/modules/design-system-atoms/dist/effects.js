...
exports.useLocationEffect = exports.useFontWeightEffect = exports.useFlexEffect = exports.useTagEffect = exports.useFontSizeEffect = exports.useStylesEffect = exports.useGradientEffect = void 0;
...
var useTagEffect = props => {
  ...
  (0, _react.useEffect)(() => {
    if (props.variants && props.variants.includes('tag')) {
      var tag = _objectSpread({}, style);

      Object.assign(tag, defaults);

      if (props.effects) {
        if (props.effects.includes('white')) Object.assign(tag, {
          bg: 'white',
          border: '1px solid #e0e0e0',
          color: '#000'
        });
        if (props.effects.includes('pointer')) Object.assign(tag, {
          cursor: 'pointer'
        });
        if (props.effects.includes('sm')) Object.assign(tag, {
          fontSize: 0,
          px: 2,
          py: 1
        });
        if (props.effects.includes('lg')) Object.assign(tag, {
          fontSize: 1,
          px: 3,
          py: 2
        });
...
exports.useTagEffect = useTagEffect;
...
var useFlexEffect = props => {
  ...
  (0, _react.useEffect)(() => {
    ...
    if (props.between) shadow = _objectSpread({}, shadow, {
      justifyContent: 'space-between'
    });
    if (props.evenly) shadow = _objectSpread({}, shadow, {
...
var useFontWeightEffect = props => {
  var [weight, setStyled] = (0, _react.useState)(400);
  (0, _react.useEffect)(() => {
