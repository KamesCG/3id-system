...
const showcase = {
  title: 'Get Setup.',
  tagline: 'Installing 3ID System and Plugin Libraries.',
}
...
const Home = props =>
  <Site sx={{ bg: 'smoke' }} sxMain={{ alignItems: 'center', justifyContent: 'center' }}>
    ...
    <Atom.Paragraph>
      Extend 3ID System with unique Plugin Systems
    </Atom.Paragraph>
    <PluginCMS />
    <PluginProfiles />
    <PluginChatroom />
...
const Install3BoxUISystem = props => {
  return (
    <Atom.Container my={3}>
      <Atom.Flex alignCenter sx={{ bg: 'white', p: 3, flex: 1, borderRadius: 8 }}>
        <Atom.Flex column flex={2} sx={{p: 4}}>
          <Atom.Heading md heavy m={0}>3ID System</Atom.Heading>
          <Atom.Paragraph m={0}>
...
const PluginCMS = props => {
  return (
    <Atom.Container my={3}>
      <Atom.Flex alignCenter sx={{ bg: 'white', p: 3, flex: 1, borderRadius: 8 }}>
        <Atom.Flex column flex={2} sx={{p: 4}}>
          <Atom.Heading md heavy m={0}>3ID System CMS</Atom.Heading>
          <Atom.Paragraph m={0}>
...
const PluginProfiles = props => {
  return (
    <Atom.Container my={3}>
      <Atom.Flex alignCenter sx={{ bg: 'white', p: 3, flex: 1, borderRadius: 8 }}>
        <Atom.Flex column flex={2} sx={{p: 4}}>
          <Atom.Heading md heavy m={0}>3ID System Profiles</Atom.Heading>
          <Atom.Paragraph m={0}>
            Add 3ID System Profile components to any application.
      </Atom.Paragraph>
        </Atom.Flex>
        <Atom.Flex flex={3}>
          <Atom.Box gradient='gray' sx={{ borderRadius: 7, boxShadow: 1, p: 3, px: 4, width: '100%' }}>
...
const PluginChatroom = props => {
  return (
    <Atom.Container my={3}>
      <Atom.Flex alignCenter sx={{ bg: 'white', p: 3, flex: 1, borderRadius: 8 }}>
        <Atom.Flex column flex={2} sx={{p: 4}}>
          <Atom.Heading md heavy m={0}>3ID System Chatroom</Atom.Heading>
          <Atom.Paragraph m={0}>
            Add 3ID System Chatrooms (powered by Ghost Threads) to any React application.
      </Atom.Paragraph>
        </Atom.Flex>
        <Atom.Flex flex={3}>
          <Atom.Box gradient='gray' sx={{ borderRadius: 7, boxShadow: 1, p: 3, px: 4, width: '100%' }}>
